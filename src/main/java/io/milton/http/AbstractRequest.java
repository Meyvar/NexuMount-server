...
public abstract class AbstractRequest implements Request {
	...
	@Override
	public abstract String getRequestHeader(Header header);
	private final Map<String, Object> attributes = new HashMap<>();

	@Override
	public Date getIfModifiedHeader() {
		String s = getRequestHeader(Header.IF_MODIFIED);
	...
	public String getExpectHeader() {
		return getRequestHeader(Header.EXPECT);
	}

	@Override
	public String getAcceptHeader() {
		return getRequestHeader(Header.ACCEPT);
	}

	@Override
	public String getAcceptLanguage() {
		return getRequestHeader(Header.ACCEPT_LANGUAGE);
	}

	@Override
	public String getRefererHeader() {
		return getRequestHeader(Header.REFERER);
	}

	@Override
	public String getContentTypeHeader() {
		return getRequestHeader(Header.CONTENT_TYPE);
	}

	@Override
	public String getAcceptEncodingHeader() {
		return getRequestHeader(Header.ACCEPT_ENCODING);
	}
	...
	public int getDepthHeader() {
		String depthStr = getRequestHeader(Header.DEPTH);
		if (depthStr == null) {
			return INFINITY;
		} else {
			switch (depthStr) {
