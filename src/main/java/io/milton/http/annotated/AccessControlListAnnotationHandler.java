...
public class AccessControlListAnnotationHandler extends AbstractAnnotationHandler {
	 ...
	 * @return
	 */
	public Set<Priviledge> availablePrivs(Object curUser, AnnoResource res, Auth auth) {
	...
	public Set<Priviledge> directPrivs(Object curUser, AnnoResource res, Auth auth) {
		Set<Priviledge> acl = EnumSet.noneOf(Priviledge.class);
	...
	private void addPrivsFromMethod(java.lang.reflect.Method method, Object target, Set<Priviledge> acl, Object curUser, AnnoResource res, Auth auth) throws Exception {
