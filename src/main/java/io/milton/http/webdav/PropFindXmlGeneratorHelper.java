...
public class PropFindXmlGeneratorHelper {
	...
	private void sendKnownProperties(XmlWriter writer, Map<String, String> mapOfNamespaces, Map<QName, ValueAndType> properties, String href) {
		sendProperties(Status.SC_OK, writer, mapOfNamespaces, properties, href);
	}

	private void sendProperties(Status status, XmlWriter writer, Map<String, String> mapOfNamespaces, Map<QName, ValueAndType> properties, String href) {
	...
	private void sendErrorProperties(Status status, XmlWriter writer, Map<String, String> mapOfNamespaces, List<NameAndError> properties) {
