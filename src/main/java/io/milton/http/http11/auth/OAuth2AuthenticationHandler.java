...
public class OAuth2AuthenticationHandler implements AuthenticationHandler {
    ...
    public boolean supports(Resource r, Request request) {
        ...
        try {
            if (r instanceof OAuth2Resource) {
                ...
                OAuth2ProfileDetails oAuth2TokenUser = null;
    ...
    public OAuth2ProfileDetails parse(OAuth2Resource oAuth2Resource, Request request) throws BadRequestException, OAuthSystemException, OAuthProblemException {
        if (request == null) {
            return null;
        }
