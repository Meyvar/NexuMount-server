...
public abstract class AbstractResponse implements Response {
    ...
    public String getResponseHeader(Header header) {
        return getNonStandardHeader(header.code);
    }

	@Override
    public void setContentEncodingHeader(ContentEncoding encoding) {
        setResponseHeader(Header.CONTENT_ENCODING, encoding.code);
    }
...
//    }
    ...
    public void sendRedirect(String url) {
        ...
        setStatus(Status.SC_MOVED_TEMPORARILY);
	...
	public void sendPermanentRedirect(String url){
        ...
        setStatus(Status.SC_MOVED_PERMANENTLY);
        setLocationHeader(url);
	}
