...
public class BerEncoder extends Ber{
...
*/
     ...
     */
    public void encodeOctetString(byte tb[], int tag) throws Ber.EncodeException {
        encodeOctetString(tb, tag, 0, tb.length);
    }

    private void encodeLength(int len) throws Ber.EncodeException {
